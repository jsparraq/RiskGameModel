...
public class RiskGameModel {
    ...
    public static void main(String[] args) {
        ...
        Session session = new Session(1,"RUN",players,new Map("ameroki_pic",new Continent[]{continent1,continent2,continent3},new Card[]{card1,card2,card3,card4,card5,card6,card7},boundary));
